            ...
            <ul class="flex items-center">
              ...
              @if ($blocks)
                @foreach ($blocks as $block)
                  @if ($block['menu'])
                    <li class="group pl-6">
                        <span v-scroll-to="'#{{$block['name']}}'" class="font-header font-semibold text-primary-content uppercase pt-0.5 cursor-pointer">
              ...
              <li class="group pl-16">
                  ...
                  <a href="tel:+380991796860" class="font-header font-semibold text-2xl text-primary-content uppercase pt-0.5 cursor-pointer flex flex-nowrap align-middle">
    ...
    <div class="w-2/3 md:w-1/3 bg-primary min-h-screen absolute right-0 shadow py-4 px-8">
        ...
        <ul class="flex flex-col mt-8">
          ...
          <li class="group pt-8">
            ...
            <a href="tel:+380991796860" class="font-header font-semibold text-base text-primary-content uppercase pt-0.5 cursor-pointer flex flex-nowrap inline-block align-middle">
