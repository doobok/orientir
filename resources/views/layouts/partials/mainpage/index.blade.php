<div class="relative bg-primary text-primary-content">
    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div class="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
            <h2 class="mb-6 font-sans text-3xl font-bold tracking-tight sm:text-4xl sm:leading-none">
          ...
          <span class="relative text-teal-900">lazy dog</span>
            ...
            <div class="flex justify-center pt-10">
                <smpl-button txt="Купить дом" cls=""></smpl-button>
            </div>
            ...
            <a
                ...
                class="flex items-center justify-center w-10 h-10 mx-auto duration-300 transform border border-gray-400 rounded-full hover:text-teal-accent-400 hover:border-teal-accent-400 hover:shadow hover:scale-110"
            >
